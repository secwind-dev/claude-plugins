...
# Hook: notify-done
# Event: Stop
# วัตถุประสงค์: แจ้งเตือนเมื่อ Claude ทำงานเสร็จ ด้วย popup + เสียง + พูดภาษาไทย
...
# ถ้าไม่มีไฟล์ → fallback เป็น "ทำเสร็จแล้ว"
...
# แสดง popup notification บน macOS
osascript -e "display notification \"${MSG}\" with title \"Claude Code\""

# เล่นเสียง notification
afplay /System/Library/Sounds/Funk.aiff

# พูดภาษาไทย ด้วย voice Kanya ความเร็ว 200
