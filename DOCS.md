...
**สำรวจ topic ซับซ้อน** — ถามตอบแบบ interactive เพื่อช่วย user เรียบเรียงความต้องการที่ยังไม่ชัดเจน บันทึกผลลง awaken อัตโนมัติ

- ไม่ระบุ topic → ถามก่อน
- ตรวจ session เก่าอัตโนมัติ — เลือกต่อจากเดิมหรือเริ่มใหม่ได้
- Aiko ออกความเห็นหลังทุกคำตอบ แต่การตัดสินใจเป็นของ user เสมอ
- บันทึกที่ `.claude/sw/awaken/<topic>-explore.md` — auto-load ทุก session
